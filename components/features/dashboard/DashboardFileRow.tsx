...
import { Copy, Trash2, Eye, DownloadCloud, ExternalLink, Pencil, Calendar } from "lucide-react";
  ...
  return (
    <>
      <div className="glass-card rounded-xl2 shadow-soft px-4 py-3 flex flex-wrap items-center gap-3">
        ...
        <button onClick={() => setShowExpiryModal(true)} className="text-slate-400 hover:text-brand transition">
          <Calendar size={18} />
        </button>
